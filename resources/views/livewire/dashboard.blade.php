    ...
    <div class="flex flex-col md:flex-row w-full p-2 space-y-4 md:space-y-0 md:space-x-4">
        ...
        <div class="md:w-1/2 space-y-4 xl:flex xl:flex-row xl:space-y-0 xl:space-x-4">
            ...
            <div class="w-full xl:w-1/2 transition duration-500 transform hover:scale-105">
                <div
                    class="relative flex justify-between overflow-hidden bg-white border border-gray-100 rounded-lg shadow-md lg:flex-wrap xl:flex-nowrap">
                    <div class="flex flex-wrap justify-between w-1/2 p-4 md:w-1/2 lg:w-7/12">
                        <div class="w-full">
                            ...
                            @endphp
                            <p
                                class="text-xs leading-tight {{ $sale2Week == 0 ? 'text-gray-400' : ($sale2Week > 0 ? 'text-green-500' : 'text-red-500') }}">
                ...
                <div
                    ...
                    <div class="flex flex-wrap justify-between w-1/2 p-4 md:w-1/2 lg:w-7/12">
                        <div class="w-full">
                            ...
                            @endphp
                            <p
                                class="text-xs leading-tight {{ $prod2Week == 0 ? 'text-gray-400' : ($prod2Week > 0 ? 'text-green-500' : 'text-red-500') }}">
            ...
            <div class="w-full xl:w-1/2 transition duration-500 transform hover:scale-105">
                <div
                    ...
                    <div class="flex flex-wrap justify-between w-1/2 p-4 md:w-1/2 lg:w-7/12">
                        ...
                        <div class="w-full text-md xl:text-lg font-semibold text-gray-700 xl:w-full xl:mt-0">
                            <h3 class="inline">Rp.
                                {{ number_format($saleWeek->sum('quantity') * 10000, '0', '', '.') }}
                            </h3>
                        </div>
                    </div>
                    <div class="w-6/12 md:w-1/2 lg:w-5/12">
            ...
            <div class="w-full xl:w-1/2 transition duration-500 transform hover:scale-105">
                <div
                    ...
                    <div class="flex flex-wrap justify-between w-1/2 p-4 md:w-1/2 lg:w-7/12">
                        ...
                        <div class="w-full text-md xl:text-lg font-semibold text-gray-700 xl:w-full xl:mt-0">
                            <h3 class="inline">Rp. {{ number_format($prodWeek->sum('quantity') * 500, '0', '', '.') }}
                            </h3>
                        </div>
                    </div>
                    <div class="w-6/12 md:w-1/2 lg:w-5/12">
        ...
        window.myBar = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [{{ $saleWeek->sum('quantity') * 10000 }},
                        {{ $prodWeek->sum('quantity') * 500 }}
                    ],
                    fill: false,
                }],
            },
